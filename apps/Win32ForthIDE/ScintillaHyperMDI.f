\ $Id: ScintillaHyperMDI.f,v 1.5 2009/04/10 16:40:24 ezraboyce Exp $
...
:M On_Close:    ( -- f )
                On_Close: super
                dup 		\ EAB added flag test Wednesday, October 29 2008
                if	self ActiveBrowser = if 0 to ActiveBrowser then
