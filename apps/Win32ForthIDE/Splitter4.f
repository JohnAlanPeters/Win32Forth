...
:Object TopLeftPane   <Super Child-Window
...
:M On_Paint: ( -- )
        ...
        0 0 s" Top Left Pane" Textout: dc ;M

;Object


:Object TopRightPane   <Super Child-Window
...
:M On_Paint: ( -- )
        0 0 Width Height white FillArea: dc
        0 0 s" Top Right Pane" Textout: dc ;M
...
: position-windows ( -- )
        0          ToolBarHeight  LeftWidthMin  TopHeightMin  Move: TopLeftPane
        RightXpos  ToolBarHeight  RightWidth    TopHeightMin  Move: TopRightPane
...
: Splitter ( -- n )   \ the splitter window the cursor is on
        ...
        IF
            2dup SplitterYpos BottomYpos within  swap  0 width within  and
            IF  2drop  2
            ELSE  ToolBarHeight StatusBarYpos within  swap  LeftWidth RightXpos within  and IF  1  ELSE  0  THEN
            THEN
        ELSE 2drop 0
        THEN ;
...
:M On_Init: ( -- )
        ...
        self Start: TopLeftPane
        self Start: TopRightPane
