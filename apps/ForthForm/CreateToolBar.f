...
:Object PreviewWindow           <Super Window
...
: LoadProperties        ( -- )
                ...
                ToolBarBitmap count SetFile: PreviewWindow ;
...
:M On_Init:	( -- )
		...
		hwnd SetParentWindow: PreviewWindow
		StartPos: Self StartSize: PreviewWindow nip - 27 - SetPos: PreviewWindow
		StartSize: self drop StartSize: PreviewWindow nip SetDim: PreviewWindow
		start: previewwindow
...
: ViewSource    ( -- )  \ view source code for a toolbar
                ...
                s" Toolbar-" pad place
                name count pad +place
                pad count ShowSource ;
...
:NoName		( -- )
                Start: frmCreateToolBar ; is doCreateToolBar
